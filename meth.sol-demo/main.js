...
const tag = ui.create_label("meth.sol (bad) remake by 4lpn using 4lpn's ui lib", ["120px","220px"], true)
...
tab1.addEventListener("click", () => {
    ...
    const label = ui.create_label("this is tab 1", ["20px","50px"], false)
    prevTab = tab1
})
...
tab2.addEventListener("click", () => {
    ...
    const label = ui.create_label("this is tab 2", ["20px","50px"], false)
    prevTab = tab2
})
...
tab3.addEventListener("click", () => {
    ...
    const label = ui.create_label("this is tab 3", ["20px","50px"], false)
    prevTab = tab3
})
...
tab4.addEventListener("click", () => {
    ...
    const label = ui.create_label("this is tab 4", ["20px","50px"], false)
    prevTab = tab4
})